# -*- encoding: utf-8 -*-
# stub: composite_primary_keys 14.0.10 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.metadata = { "changelog_uri" => "https://github.com/composite-primary-keys/composite_primary_keys/blob/master/History.rdoc" } if s.respond_to? :metadata=
