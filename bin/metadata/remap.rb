...
METADATA_TABLES = %i[concept concept_name concept_set concept_answer concept_datatype concept_derived
                     concept_description concept_map concept_name_tag concept_name_tag_map concept_numeric
                     concept_proposal concept_proposal_tag_map concept_set_derived concept_source
                     concept_state_conversion concept_synonym concept_word encounter_type patient_identifier_type
                     order_type person_attribute_type program program_workflow program_workflow_state relationship_type
                     drug privilege location role].freeze
