  ...
  module Reports
    ...
    class RegimenDispensationData
      ...
      def drop_regimen_data
        execute_query "DROP TABLE IF EXISTS #{temp_current_dispensation}"
        execute_query "DROP TABLE IF EXISTS #{temp_drug_dispensed}"
        execute_query "DROP TABLE IF EXISTS #{temp_current_regimen_names}"
        execute_query "DROP TABLE IF EXISTS #{temp_current_patient_regimen}"
        execute_query "DROP TABLE IF EXISTS #{temp_reg_outcome}"
        execute_query "DROP TABLE IF EXISTS #{temp_vl_results}"
        execute_query "DROP TABLE IF EXISTS #{temp_current_vl_results}"
        execute_query "DROP TABLE IF EXISTS #{temp_regimen_patient_weight}"
        execute_query "DROP TABLE IF EXISTS #{temp_regimen_data}"
        execute_query "DROP TABLE IF EXISTS #{temp_patient_start_date}"
      end
      ...
      def create_temp_current_dispensation
        ...
        SQL
        ActiveRecord::Base.connection.execute "CREATE INDEX #{idx_current_disp} ON #{temp_current_dispensation} (patient_id, start_date)"
      end
      ...
      def create_temp_drug_dispensed
        ActiveRecord::Base.connection.execute <<~SQL
          ...
          AND o.order_type_id = #{@drug_order_type_id}
        SQL
        ActiveRecord::Base.connection.execute "CREATE INDEX #{idx_drug_disp} ON #{temp_drug_dispensed} (patient_id, start_date)"
      end
      ...
      def create_temp_current_regimen
        ...
        SQL
        ActiveRecord::Base.connection.execute "CREATE INDEX #{idx_regimen_names} ON #{temp_current_regimen_names} (drugs(50))"
      end
      ...
      def create_temp_current_patient_regimen
        ...
        SQL
        ActiveRecord::Base.connection.execute "CREATE INDEX #{idx_patient_regimen} ON #{temp_current_patient_regimen} (patient_id)"
      end
      ...
      def create_temp_patient_outcome
        ActiveRecord::Base.connection.execute <<~SQL
          ...
          FROM #{temp_current_dispensation} AS temp_current_dispensation
          #{dsd_query(dsd: @dsd, model: 'temp_current_dispensation') if @dsd}
        SQL
        ActiveRecord::Base.connection.execute "CREATE INDEX #{idx_reg_outcome} ON #{temp_reg_outcome} (patient_id)"
      end
      ...
      def create_temp_vl_result
        ...
        SQL
        ActiveRecord::Base.connection.execute "CREATE INDEX #{idx_vl_result} ON #{temp_vl_results} (patient_id, result_date)"
      end
      ...
      def create_temp_current_vl_results
        ...
        SQL
        ActiveRecord::Base.connection.execute "CREATE INDEX #{idx_current_vl} ON #{temp_current_vl_results} (patient_id)"
      end
      ...
      def create_temp_regimen_patient_weight
        ...
        SQL
        ActiveRecord::Base.connection.execute "CREATE INDEX #{idx_patient_weight} ON #{temp_regimen_patient_weight} (patient_id)"
      end
      ...
      def create_temp_patient_start_date
        ActiveRecord::Base.connection.execute <<~SQL
          ...
          SELECT
            ...
            art_dates.earliest_start_date AS `earliest_start_date`
           FROM
              ((`patient_program` `p`
        ...
        SQL
        ActiveRecord::Base.connection.execute "CREATE INDEX #{idx_start_date} ON #{temp_patient_start_date} (patient_id)"
      end
