...
module NcdService
  class ReportEngine
    ...
    REPORTS = {
      'NCD_DASHBOARD' => NcdService::Reports::NcdDashboard,
      'DIAGNOSIS' => NcdService::Reports::Diagnosis,
      'ATTENDANCE' => NcdService::Reports::Attendance,
      'DRUG' => NcdService::Reports::DrugReport,
    }.freeze
