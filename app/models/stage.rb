class Stage < ApplicationRecord
    ...
    VALID_STAGES = %w[
      ...
      SCREENING ASSESSMENT TRIAGE DISPOSITION SPECIALTY TEST_RESULTS REGISTRATION
      PRE_ADMISSION ADMITTED_PATIENTS DRUG_AND_SUNDRIES_ORDERS INWARD_CONSULTATION RADIOLOGY HTS
    ].freeze
