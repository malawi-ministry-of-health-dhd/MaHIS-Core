  ...
  module V1
    class StagesController < ApplicationController
      ...
      def stage_params
        ...
        params.permit(
          :patient_id, :identifier, :visit_number, :stage, :arrival_time,
          :location_id, :program_id, :provider_id, :operation_id, :sync_status
        )
      end

      def index_filters
        params.permit(:stage, :location_id, :patient_id, :identifier, :program_id)
      end
    end
  end
end
